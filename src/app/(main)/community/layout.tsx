...
export default function CommunityLayout({
  ...
  const isLibraryPage = pathname.startsWith('/community/library');

  return (
    <div className={`w-full mx-auto text-black ${isLibraryPage ? '' : 'max-w-6xl py-8'}`}>
      {!isLibraryPage && (
        <>
          {/* Community Directory Title */}
          <div className="mb-8 border-b border-gray-150 pb-4 px-4 md:px-0">
          ...
          <div className="flex flex-wrap gap-1 mb-8 bg-gray-50 p-1 border border-gray-200 rounded-full w-fit mx-4 md:mx-0">
            <Link

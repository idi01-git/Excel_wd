...
export default function Loader({
  title = "Curating the Sanctuary...",
  subtitle = "Preparing the literary archives and chronicles of Excelsior",
  size = "md",
  className,
  ...props
}: LoaderProps) {
    ...
    >
      ...
      >
        ...
        <motion.h2
          ...
          className={cn(
            config.titleClass,
            "font-serif tracking-tight text-foreground/90 antialiased"
          )}
        ...
        <motion.p
          ...
          className={cn(
            ...
            "font-sans font-normal text-muted-foreground/80 leading-relaxed tracking-normal antialiased"
          )}
